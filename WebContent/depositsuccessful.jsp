      ...
      <div class="btn-wrapper">
          <div class="panel box-shadow-none content-header">
            <div class="panel-body">
              <div class="col-md-12">
                  <h3 class="animated fadeInLeft">Amount Deposited Successfully</h3>
...
</th><th>CUSTOMER ID</th><th>PREVIOUS BALANCE</th><th>LATEST BALANCE</th></tr>
</thead>
<tbody>
<tr>
<td>&nbsp;<%=request.getAttribute("acid") %></td>
<td>&nbsp; <%=request.getAttribute("custid") %></td>
<td>&nbsp; <%=request.getAttribute("accbl") %></td>
