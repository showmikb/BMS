          ...
          <div id="content">
             <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Customer Status</h3>
                        ...
                        <form id="example1" action="Customer" method="post">
                            ...
                            <fieldset>
                                <legend>Enter The Following Information</legend>
                         		<input type="hidden" name="page" value="custstatfetchcustomer"> 
                                <label for="userName-2">SSNID *</label>
                                <input id="userName-2" name="ssnid" type="text" class="required">
                                <label for="userName-2">Customer Id *</label>
                                <input id="custid" name="custid" type="text" class="required" required>
