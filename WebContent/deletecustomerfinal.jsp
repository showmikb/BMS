          ...
          <div id="content">
             <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Delete Customer</h3>
                        ...
                        <form id="example1" action="Customer" method="post">
                            ...
                            <fieldset>
                                ...
                                <% 
							     ...
							     %>
                         		<input type="hidden" name="page" value="deletecustomerfinal"> 
                                ...
                                <input id="userName-2" name="name" type="text" value="<%=(String)j3.get("ws_cust_name")%>" readonly>
                                <label for="userName-2">Address *</label>
                                <input id="userName-2" name="addr" type="text" value="<%=(String)j3.get("ws_cust_adrs")%>" readonly>
                                <label for="userName-2">Age *</label>
                                <input id="userName-2" name="age" type="text" value="<%=(String)j3.get("ws_cust_age")%>" readonly>
