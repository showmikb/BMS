...
function validate()
{
	var salary=document.myForm.custid.value;
     var letters=/^[0-9]+$/;
	if(salary!=null && salary.length==9)
	{
	if(letters.test(salary)){
		alert("please enter proper customer id");
		document.myForm.custid.focus();
		return false;
	}
	}
	else
                    ...
                    <div class="panel-body">
                         <form id="example1" action="ControllerTeller"  method="post">
                            ...
                            <fieldset align="center" >
                                <legend>Enter The Following Information To Get Mini Statement</legend>
                         

<input type="hidden" name="page" value="getmini">

	
		Account Id
		<input type="text" name="accid" id="accid">
<br><br>
		Start Date
		<input type="text" name="sdate" id="sdate" value="ccyy-mm-dd" >
<br><br>
	
		End Date
		<input type="text" name="edate" id="edate" value="ccyy-mm-dd" >
	
                            
                     
                      <br><br><br><br>
                             <button class="btn-flip btn btn-raised btn-info" onclick="validation()">
                                <div class="flip">
                                  <div class="side">
