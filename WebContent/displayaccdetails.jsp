...
function validation(){
	var sid=document.getElementById("custid").value;
	var AccountId=document.getElementById("acid").value;
	var num=/^[0-9]+$/;
	var letters=/^[A-Za-z]+$/;
	
	if(sid==""){
		alert("Please enter a SSN ID");
		document.CustomerCreate.sid.focus();
		return false;
	}
	 if(!sid.match(num)){
	   ...
	   /* if(age==""){
			...
			document.CustomerCreate.age.focus();
			return false;
		}
		 if(isNaN(age)){
