      ...
      <div class="btn-wrapper">
          <div class="panel box-shadow-none content-header">
            <div class="panel-body">
              <div class="col-md-12">
                  <h3 class="animated fadeInLeft">MINI STATEMENT</h3>
...
<tbody>
<%Object obj=request.getAttribute("arrList");
ArrayList<Transaction> arr=null;
	if(obj!=null){
		arr=(ArrayList<Transaction>)obj;
	%>
	<% Iterator<Transaction> iter=arr.iterator();
	
	while (iter.hasNext())
	{
     Transaction t=iter.next();	
     if(t.getTrans_id().equals(""))
     {}
     else
     {
	%>
