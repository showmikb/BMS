          ...
          <div id="content">
            ...
            <div class="col-md-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form id="example1" action="ControllerTeller"  method="post" align="center">
                      ...
                      <div class="col-md-3">
                              <button class="btn-flip btn btn-raised btn-info" align="center" >
                                <div class="flip">
                                  <div class="side">
                        ...
                        <form name="myForm" id="example1" action="ControllerTeller"  method="post" onsubmit="validate()" align="center">
