          ...
          <div id="content">
             <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">Update Customer</h3>
                        ...
                        <form id="example1" action="Customer" method="post">
                            ...
                            <fieldset>
                                ...
                                <% 
							     ...
							     %>
                         		<input type="hidden" name="page" value="updatecustomerfinal"> 
                         		<label for="userName-2">SSNID *</label>
                                <input id="userName-2" name="ssnid" type="text" value="<%=(String)j3.get("ws_cust_ssn")%>" readonly>
                                <label for="userName-2">Customer Id *</label> 
                                <input id="userName-2" name="custid" type="text" class="required"  value="<%=(String)j3.get("ws_id")%>" readonly>
                                <label for="userName-2">Name *</label>
                                <input id="userName-2" name="name" type="text" value="<%=(String)j3.get("ws_cust_name")%>" required>
                                <label for="userName-2">Address *</label>
                                <input id="userName-2" name="addr" type="text" value="<%=(String)j3.get("ws_cust_adrs")%>" required>
                                <label for="userName-2">Age *</label>
                                <input id="userName-2" name="age" type="text" value="<%=(String)j3.get("ws_cust_age")%>" required>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    form.steps({
        ...
        {
         	alert("Customer Update Initiated Successfully!!")
