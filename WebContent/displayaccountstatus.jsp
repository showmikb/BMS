          ...
          <div id="content">
             <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h3 class="animated fadeInLeft">ACCOUNTS</h3>
                            ...
                            <fieldset>
                            	<input type="hidden" name="page" value="update">	
                             	 <% 
							       ...
							       JSONObject j3=j2.getJSONObject("TF000061OperationResponse"); 
							   
							       String custid=(String)j3.get("ws_id");
							       JSONObject j4=j3.getJSONObject("ws_out_data");
							       String remark1=(String)j4.get( "ws_remark_1");
							       String lupdate1=(String)j4.get("ws_ts_1");
								 
							       String remark2=(String)j4.get( "ws_remark_2");
							       String lupdate2=(String)j4.get("ws_ts_2");
